...
using Unity.Jobs;
using System;
using ADBRunTimeJobsTable = TKPackages.TKPhysics.Internal.ADBRunTimeJobsTable;
using Internal_ADBRunTimeJobsTable = TKPackages.TKPhysics.Internal.ADBRunTimeJobsTable;

namespace TKPackages.TKPhysics
{
    using Internal;
    using TKPhysics.Runtime;
    using System.Linq;
    using BurstLinq;
    using static Internal_ADBRunTimeJobsTable;
